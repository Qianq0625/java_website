...
<title>后台管理 - 图书商城</title>
<link type="text/css" rel="stylesheet" href="../css/style.css" />
<script type="text/javascript" src="..//scripts/function-manage.js"></script>
<script type="text/javascript" src="..//scripts/calendar.js"></script>
<script type="text/javascript">
function checkusername(){
	var username=document.getElementById("userName").value;   //取出文本框里的值
	if(username==""){
		document.getElementById("sp").innerHTML="<font color='red'>用户名不能为空</font>";  //id，获取其中的值
...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="productSetect">商品</a></li>
...
<div id="position" class="wrap">
	您现在的位置：<a href="user_add.jsp">图书商城</a> &gt; 管理后台
</div>
